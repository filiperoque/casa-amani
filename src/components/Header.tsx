      ...
      >
        ...
        <div className="relative">
          ...
          <a
            ...
            className={`plausible-event-name=outbound-airbnb absolute right-0 top-1/2 -translate-y-1/2 whitespace-nowrap bg-warm-deep px-6 py-2 font-display text-sm uppercase tracking-cta text-cream hover:scale-[1.02] hover:bg-warm-deep/90 active:scale-[0.96] ${
