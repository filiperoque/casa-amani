  ...
  return (
    <>
      ...
      <div className="relative z-10 flex w-full flex-1 flex-col items-center justify-center gap-8 px-6 pb-16 pt-10 mix-blend-lighten md:gap-10 md:px-[120px]">
        ...
        <p
          className="mx-auto max-w-[600px] text-center text-sm leading-[1.65] text-cream/80 transition-all duration-[800ms] ease-[cubic-bezier(0.22,1,0.36,1)] md:text-base md:leading-[1.7]"
          style={{
            opacity: stage >= 3 ? 1 : 0,
        ...
        <a
          ...
          style={{
            ...
            transitionDuration: stage >= 4 ? "800ms" : "0ms",
