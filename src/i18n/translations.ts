...
const translations = {
  en: {
    ...
    staysInclude: {
      title: "All stays include",
      items: [
        "Bed linens, bath towels, hand towels, pool towels and beach towels",
        "Pre-arrival cleaning and weekly housekeeping",
        "Mid-stay linen and towel change for stays over seven nights",
        "Weekly pool maintenance and garden upkeep",
        "Starter pack: coffee capsules, sugar, dishwashing supplies, laundry tablets, garbage bags, hand soap, toilet paper",
        "Self check-in via smart lock, with access codes shared 48 hours before arrival",
        "Welcome booklet in four languages",
        "24-hour guest assistance line",
      ],
    },
    amenities: {
      title: "Amenities",
      items: [
        ...
        "Smart TV with Netflix, Bluetooth speaker and stereo system",
        "Fibre Wi-Fi throughout the house and terrace",
        "Air conditioning in every room (cooling and heating)",
        "Washing machine and tumble dryer",
        "Hair dryer; iron and ironing board",
        "Safe deposit",
        "Smoke detector, carbon monoxide detector, fire extinguisher and first aid kit",
    ...
    privacy: {
      ...
      p4: "To request removal of your email or to ask questions, write to",
    },
  },
  pt: {
    landing: {
    ...
    rooms: {
      ...
      kitchen: {
        title: "A COZINHA",
        description:
          "cozinha totalmente equipada junto à sala, usada diariamente desde o pequeno-almoço até refeições mais longas.",
      },
      lowerRoom: {
    ...
    staysInclude: {
      title: "Todas as estadias incluem",
      items: [
        "Roupa de cama, toalhas de banho, toalhas de mão, toalhas de piscina e toalhas de praia",
        "Limpeza antes da chegada e limpeza semanal",
        "Troca de roupa de cama e toalhas a meio da estadia para estadias de mais de sete noites",
        "Manutenção semanal da piscina e do jardim",
        "Kit de boas-vindas: cápsulas de café, açúcar, detergente da loiça, pastilhas para a máquina de roupa, sacos do lixo, sabonete, papel higiénico",
        "Check-in autónomo por fechadura inteligente, com códigos enviados 48 horas antes da chegada",
        "Caderno de boas-vindas em quatro línguas",
        "Linha de apoio ao hóspede, 24 horas",
      ],
    },
    amenities: {
      title: "Comodidades",
      items: [
        ...
        "Smart TV com Netflix, coluna Bluetooth e sistema de som",
        "Wi-Fi de fibra em toda a casa e no terraço",
        "Ar condicionado em todas as divisões (frio e calor)",
        "Máquina de lavar e máquina de secar roupa",
        "Secador de cabelo; ferro e tábua de engomar",
        "Cofre",
        "Detector de fumo, detector de monóxido de carbono, extintor e kit de primeiros socorros",
        "Berço e cadeira alta a pedido",
        "Garagem privada para dois carros",
      ],
    },
    subscribe: {
    ...
    thePlace: {
      ...
      golfTitle: "golf",
      golfP1:
        "A Madeira tem três campos de dezoito buracos. O Palheiro Golf fica acima do Funchal, na costa sul, desenhado por Cabell Robinson e integrado na encosta sobre a baía. O Santo da Serra Golf, desenhado por Robert Trent Jones Sr., acolhe o Madeira Open e atravessa floresta de loureiros em altitude. O Porto Santo Golf, desenhado por Seve Ballesteros, ocupa a ilha vizinha e chega-se lá de ferry ou num voo curto a partir do Funchal.",
      golfP2:
        "A partir de Arco da Calheta, Palheiro e Santo da Serra ficam a quarenta e cinco a cinquenta minutos de carro. Os tee times podem ser organizados a partir da casa, com transporte de ida e volta a pedido.",
    },
    experiences: {
      title: "Experiências",
      intro:
        "Serviços organizados na casa. Com aviso prévio, antes da chegada ou durante a estadia.",
      items: [
        { title: "Golf", description: "Marcação de tee times no Palheiro Golf e Santo da Serra, com transporte de ida e volta. Aluguer de equipamento e aulas a pedido." },
        { title: "Chef privado", description: "Chefs que cozinham na casa. De um almoço informal no terraço a um menu de degustação com vinho." },
        { title: "Massagem e terapia corporal", description: "Terapeutas que vêm à casa. Interior ou terraço." },
        { title: "Treino pessoal", description: "Um treinador para sessões no terraço ou pelos caminhos da aldeia." },
        { title: "Yoga", description: "Um professor vem à casa. De manhã ou ao fim do dia, no terraço." },
        { title: "Despensa à chegada", description: "A cozinha cheia quando chega. A sua lista, no balcão." },
        { title: "Babysitting", description: "Babysitters que vêm à casa. Inglês e português." },
        { title: "Flores", description: "Flores na casa à chegada. Para um aniversário ou uma estadia mais longa." },
      ],
    },
    reservation: {
  ...
  de: {
    ...
    staysInclude: {
      title: "Jeder Aufenthalt beinhaltet",
      items: [
        "Bettwäsche, Badetücher, Handtücher, Pooltücher und Strandtücher",
        "Reinigung vor der Ankunft und wöchentliche Reinigung",
        "Wechsel von Bettwäsche und Handtüchern zur Mitte des Aufenthalts bei mehr als sieben Nächten",
        "Wöchentliche Poolpflege und Gartenpflege",
        "Starterpaket: Kaffeekapseln, Zucker, Spülmittel, Waschmitteltabs, Müllbeutel, Handseife, Toilettenpapier",
        "Selbst-Check-in per Smart Lock, Zugangscodes werden 48 Stunden vor Ankunft mitgeteilt",
        "Willkommensheft in vier Sprachen",
    ...
    amenities: {
      ...
      items: [
        ...
        "Smart TV mit Netflix, Bluetooth-Lautsprecher und Stereoanlage",
        "Glasfaser-WLAN im gesamten Haus und auf der Terrasse",
        "Klimaanlage in jedem Raum (Kühlen und Heizen)",
        "Waschmaschine und Trockner",
        "Föhn; Bügeleisen und Bügelbrett",
        "Safe",
        "Rauchmelder, Kohlenmonoxidmelder, Feuerlöscher und Erste-Hilfe-Set",
        "Kinderbett und Hochstuhl auf Anfrage",
        "Privatgarage für zwei Autos",
      ],
    },
    subscribe: {
    ...
    thePlace: {
      ...
      golfTitle: "Golf",
      golfP1:
        "Madeira hat drei Achtzehn-Loch-Plätze. Palheiro Golf liegt oberhalb von Funchal an der Südküste, entworfen von Cabell Robinson und in den Hang über der Bucht eingebettet. Santo da Serra Golf, entworfen von Robert Trent Jones Sr., ist Austragungsort des Madeira Open und führt durch Lorbeerwald auf Höhenlage. Porto Santo Golf, entworfen von Seve Ballesteros, liegt auf der Nachbarinsel und ist per Fähre oder Kurzflug ab Funchal erreichbar.",
      golfP2:
        "Von Arco da Calheta sind Palheiro und Santo da Serra fünfundvierzig bis fünfzig Autominuten entfernt. Tee-Times können vom Haus aus organisiert werden, mit Transfer zum und vom Platz auf Anfrage.",
    },
    experiences: {
      title: "Erlebnisse",
      intro:
        "Auf Wunsch organisiert. Mit Vorlauf, vor der Anreise oder während des Aufenthalts.",
      items: [
        { title: "Golf", description: "Tee-Times im Palheiro Golf und Santo da Serra, mit Transfer zum und vom Platz. Ausrüstungsverleih und Unterricht auf Anfrage." },
        { title: "Privatkoch", description: "Köche, die im Haus kochen. Vom entspannten Mittagessen auf der Terrasse bis zum Degustationsmenü mit Wein." },
        { title: "Massage und Körperarbeit", description: "Therapeuten, die ins Haus kommen. Drinnen oder auf der Terrasse." },
        { title: "Personal Training", description: "Ein Trainer für Einheiten auf der Terrasse oder auf den Dorfwegen." },
        { title: "Yoga", description: "Ein Lehrer kommt ins Haus. Morgens oder abends, auf der Terrasse." },
        { title: "Einkauf vor Anreise", description: "Die Küche voll, wenn Sie ankommen. Ihre Liste, auf der Anrichte." },
        { title: "Kinderbetreuung", description: "Babysitter, die ins Haus kommen. Englisch und Portugiesisch." },
        { title: "Blumen", description: "Blumen im Haus bei der Ankunft. Zum Jahrestag oder für einen längeren Aufenthalt." },
      ],
    },
    reservation: {
  ...
  fr: {
    ...
    staysInclude: {
      title: "Chaque séjour comprend",
      items: [
        "Draps, serviettes de bain, serviettes de toilette, serviettes de piscine et serviettes de plage",
        "Ménage avant l'arrivée et ménage hebdomadaire",
        "Changement de draps et serviettes à mi-séjour pour les séjours de plus de sept nuits",
        "Entretien hebdomadaire de la piscine et du jardin",
        "Kit de bienvenue : capsules de café, sucre, produit vaisselle, tablettes de lessive, sacs poubelle, savon pour les mains, papier toilette",
        "Arrivée autonome par serrure connectée, codes d'accès envoyés 48 heures avant l'arrivée",
        "Livret d'accueil en quatre langues",
        "Assistance aux hôtes 24 heures sur 24",
      ],
    },
    amenities: {
      title: "Équipements",
      items: [
        ...
        "Smart TV avec Netflix, enceinte Bluetooth et système audio",
        "Wi-Fi fibre dans toute la maison et sur la terrasse",
        "Climatisation dans chaque pièce (froid et chaud)",
        "Lave-linge et sèche-linge",
        "Sèche-cheveux ; fer et planche à repasser",
        "Coffre-fort",
        "Détecteur de fumée, détecteur de monoxyde de carbone, extincteur et trousse de premiers secours",
        "Lit bébé et chaise haute sur demande",
        "Garage privé pour deux voitures",
      ],
    },
    subscribe: {
    ...
    thePlace: {
      ...
      golfTitle: "golf",
      golfP1:
        "Madère compte trois parcours de dix-huit trous. Palheiro Golf se trouve au-dessus de Funchal sur la côte sud, dessiné par Cabell Robinson et intégré au flanc de colline au-dessus de la baie. Santo da Serra Golf, dessiné par Robert Trent Jones Sr., accueille le Madeira Open et traverse une forêt de lauriers en altitude. Porto Santo Golf, dessiné par Seve Ballesteros, occupe l'île voisine, accessible en ferry ou en vol court depuis Funchal.",
      golfP2:
        "Depuis Arco da Calheta, Palheiro et Santo da Serra sont à quarante-cinq à cinquante minutes en voiture. Les tee-times peuvent être organisés depuis la maison, avec transfert aller-retour sur demande.",
    },
    experiences: {
      title: "Expériences",
      intro:
        "Services organisés à la maison. Sur demande, avant l'arrivée ou pendant le séjour.",
      items: [
        { title: "Golf", description: "Réservation de tee-times au Palheiro Golf et Santo da Serra, avec transfert aller-retour. Location de matériel et cours sur demande." },
        { title: "Chef privé", description: "Des chefs qui cuisinent à la maison. Du déjeuner décontracté sur la terrasse au menu dégustation accompagné de vin." },
        { title: "Massage et soins corporels", description: "Des thérapeutes qui viennent à la maison. À l'intérieur ou sur la terrasse." },
        { title: "Coaching sportif", description: "Un coach pour des séances sur la terrasse ou le long des chemins du village." },
        { title: "Yoga", description: "Un professeur vient à la maison. Matin ou soir, sur la terrasse." },
        { title: "Courses avant l'arrivée", description: "La cuisine pleine quand vous arrivez. Votre liste, sur le plan de travail." },
        { title: "Baby-sitting", description: "Des baby-sitters qui viennent à la maison. Anglais et portugais." },
        { title: "Fleurs", description: "Des fleurs dans la maison à l'arrivée. Pour un anniversaire ou un long séjour." },
      ],
    },
    reservation: {
  ...
  pl: {
    ...
    staysInclude: {
      title: "Każdy pobyt obejmuje",
      items: [
        "Pościel, ręczniki kąpielowe, ręczniki do rąk, ręczniki basenowe i ręczniki plażowe",
        "Sprzątanie przed przyjazdem i cotygodniowe sprzątanie",
        "Wymiana pościeli i ręczników w połowie pobytu przy pobytach dłuższych niż siedem nocy",
        "Cotygodniowa konserwacja basenu i pielęgnacja ogrodu",
        "Zestaw powitalny: kapsułki do kawy, cukier, płyn do naczyń, tabletki do prania, worki na śmieci, mydło do rąk, papier toaletowy",
        "Samodzielne zameldowanie przez zamek elektroniczny, kody dostępu wysyłane 48 godzin przed przyjazdem",
        "Broszura powitalna w czterech językach",
        "Linia pomocy dla gości, 24 godziny na dobę",
      ],
    },
    amenities: {
      title: "Wyposażenie",
      items: [
        ...
        "Smart TV z Netflix, głośnik Bluetooth i system stereo",
        "Wi-Fi światłowodowe w całym domu i na tarasie",
        "Klimatyzacja w każdym pokoju (chłodzenie i ogrzewanie)",
        "Pralka i suszarka",
        "Suszarka do włosów; żelazko i deska do prasowania",
        "Sejf",
        "Czujnik dymu, czujnik tlenku węgla, gaśnica i apteczka pierwszej pomocy",
        "Łóżeczko dziecięce i krzesełko do karmienia na życzenie",
        "Prywatny garaż na dwa samochody",
      ],
    },
    subscribe: {
    ...
    thePlace: {
      ...
      golfTitle: "golf",
      golfP1:
        "Madera ma trzy pola osiemnastodołkowe. Palheiro Golf leży powyżej Funchal na południowym wybrzeżu, zaprojektowane przez Cabella Robinsona i wkomponowane w zbocze nad zatoką. Santo da Serra Golf, zaprojektowane przez Roberta Trenta Jonesa Sr., jest gospodarzem Madeira Open i prowadzi przez laurowy las na wysokości. Porto Santo Golf, zaprojektowane przez Seve Ballesterosa, zajmuje sąsiednią wyspę, dostępną promem lub krótkim lotem z Funchal.",
      golfP2:
        "Z Arco da Calheta, Palheiro i Santo da Serra są w odległości czterdziestu pięciu do pięćdziesięciu minut jazdy samochodem. Tee-times mogą być zorganizowane z domu, z transportem na pole i z powrotem na życzenie.",
    },
    experiences: {
      title: "Usługi",
      intro:
        "Organizowane na miejscu. Z wyprzedzeniem, przed przyjazdem lub w trakcie pobytu.",
      items: [
        { title: "Golf", description: "Rezerwacja tee-times w Palheiro Golf i Santo da Serra, z transportem na pole i z powrotem. Wypożyczenie sprzętu i lekcje na życzenie." },
        { title: "Prywatny szef kuchni", description: "Kucharze, którzy gotują w domu. Od swobodnego lunchu na tarasie po menu degustacyjne z winem." },
        { title: "Masaż i terapia ciała", description: "Terapeuci, którzy przyjeżdżają do domu. Wewnątrz lub na tarasie." },
        { title: "Trening personalny", description: "Trener na sesje na tarasie lub ścieżkami wioski." },
        { title: "Yoga", description: "Nauczyciel przyjeżdża do domu. Rano lub wieczorem, na tarasie." },
        { title: "Zakupy przed przyjazdem", description: "Kuchnia pełna, gdy przyjedziesz. Twoja lista, na blacie." },
        { title: "Opieka nad dziećmi", description: "Opiekunki, które przyjeżdżają do domu. Angielski i portugalski." },
        { title: "Kwiaty", description: "Kwiaty w domu na powitanie. Na rocznicę lub dłuższy pobyt." },
      ],
    },
    reservation: {
